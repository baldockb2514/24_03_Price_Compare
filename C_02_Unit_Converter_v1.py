...
while True:
    while True:
        ...
        try:
            ...
            get_unit = string_check("Weight unit? ", ["g", "mg", "kg", "xxx", "ml", "l", "kl"],
                                    ["gram", "milligram", "kilogram", "xxx", "millilitres", "litres", "kilolitres"],
        ...
        # otherwise,separate amount from unit
            ...
            if len(get_unit) > 2:
                ...
                get_unit_short = ["mg", "g", "kg", "ml", "l", "kl", "xxx"]
                list_location = get_unit_long.index(get_unit)
                get_unit = get_unit_short[list_location]
